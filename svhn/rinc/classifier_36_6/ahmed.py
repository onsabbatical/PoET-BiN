...
MulticlassBNNout = np.zeros((10000,10))
MuliclassConfidence = np.zeros((10000,10))
MuliclassConfidence2 = np.zeros((10000,10))
MulticlassBNNout = np.zeros((10000,10))
...
accuracy = np.sum(f_o == y_test).astype(float)/100
