...
torch_tr_l = torch_tr_l_temp.reshape(967,100).type(torch.LongTensor)
torch_te_l = torch_te_l_temp[:26000].reshape(260,100).type(torch.LongTensor)

trainloader = (torch_train.reshape(967,100,60)).type(torch.FloatTensor)
testloader  = torch_test[:26000,:].reshape(260,100,60).type(torch.FloatTensor)
