...
class Net(nn.Module):
    def __init__(self):
    	...
    	self.fc00 = Linear(6,1)
        self.fc01 = Linear(6,1)
        self.fc02 = Linear(6,1)
        self.fc03 = Linear(6,1)
        self.fc04 = Linear(6,1)
        self.fc05 = Linear(6,1)
        self.fc06 = Linear(6,1)
        self.fc07 = Linear(6,1)
        self.fc08 = Linear(6,1)
        self.fc09 = Linear(6,1)
        self.batch5 = nn.BatchNorm1d(10,eps = 1e-4)
