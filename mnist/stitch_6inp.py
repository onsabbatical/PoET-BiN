...
train_input_5 = np.load('train_input_5.npy')
...
train_input_f2 = np.append(train_input_f1,train_input_4,axis=0)
train_input = np.append(train_input_f2,train_input_5,axis=0)
...
train_output_5 = np.load('train_output_5.npy')
...
train_output_f2 = np.append(train_output_f1,train_output_4,axis=0)
train_output = np.append(train_output_f2,train_output_5,axis=0)
...
train_label_5 = np.load('train_labels_5.npy')
...
train_label_f2 = np.append(train_label_f1,train_label_4,axis=0)
train_label = np.append(train_label_f2,train_label_5,axis=0)
